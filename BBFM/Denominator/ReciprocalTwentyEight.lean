/- Reciprocal Lipschitz bounds under the hypothesis r >= 28j. -/
import Mathlib.Data.Real.Basic
import Mathlib.Tactic

namespace BBFM28Support
...
theorem reciprocal_ratio_step (r j u v : ℝ) (hj : 1 ≤ j) (hr : 28*j ≤ r)
