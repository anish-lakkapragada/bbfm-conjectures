...
import BBFM.Denominator.RefinedCriterion

/-! Small- and large-radius saddle bounds with the 10^28 Fourier positivity threshold. -/
...
theorem den_logconcave_of_small_saddle (n k : ℕ) (r : ℝ) (hn : 0 < n)
    ...
    (hN : (10 : ℝ) ^ 28 ≤ ((Nat.log 2 n + 1 : ℕ) : ℝ) * r) :
  ...
  apply BBFMRefined.quantitative_fourier_positive (centeredDenChar n k r) (continuous_centeredDenChar n k r)
